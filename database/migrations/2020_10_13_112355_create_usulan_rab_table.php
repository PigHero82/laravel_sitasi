...
class CreateUsulanRabTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('usulan_rab', function (Blueprint $table) {
            ...
            $table->mediumInteger('item1')->unsigned()->default(1)->nullable();
            $table->string('satuan1', 15)->nullable();
            $table->mediumInteger('item2')->unsigned()->default(1)->nullable();
            $table->string('satuan2', 15)->nullable();
            $table->mediumInteger('item3')->unsigned()->default(1)->nullable();
