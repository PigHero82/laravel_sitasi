<div class="main-menu-content">
    <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
        @if (request()->is('admin*'))
            <li class="{{ (strpos(Route::currentRouteName(), 'admin.index') == 0) ? 'active' : '' }} nav-item"><a href="{{ route('admin.index') }}"><i class="feather icon-home"></i><span class="menu-title">Dashboard</span></a></li>
            <li class="nav-item"><a href="#"><i class="feather icon-mail"></i><span class="menu-title">Data Master</span></a>
                <ul class="menu-content">
                    <li class="{{ (strpos(Route::currentRouteName(), 'admin.master.dosen.index') == 1) ? 'active' : '' }}"><a href="#"><i></i><span class="menu-item">Dosen</span></a></li>
